...
@Mixin(ItemStatisticsList.class)
public interface ItemStatisticsListAccessor {

    @Accessor("blockColumns")
    List<StatType<Block>> exportstats$getBlockColumns();

    @Accessor("itemColumns")
    List<StatType<Item>> exportstats$getItemColumns();
}
